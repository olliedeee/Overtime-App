...
describe 'navigate' do
  ...
  let(:post) do
    Post.create(date: Date.today, work_performed: "performed", user_id: user.id, daily_hours: 3.5)
  end
  ...
  describe 'index' do
    ...
    it 'has a scope so that only post creators can see their posts' do
      other_user = User.create(first_name: 'Non', last_name: 'Authorized', email: "nonauth@example.com", password: "asdfasdf", password_confirmation: "asdfasdf", phone: "12345678901")
  ...
  describe 'new' do
    it 'has a link from the homepage' do
      employee = Employee.create(first_name: 'Employee', last_name: 'Authorized', email: "employee@example.com", password: "asdfasdf", password_confirmation: "asdfasdf", phone: "12345678901")
